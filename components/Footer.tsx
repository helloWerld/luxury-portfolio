export default function Footer() {
  ...
  return (
    <footer className=" border-t border-secondary/20 py-6 md:py-8 bg-black text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between">
        <div className="text-center md:text-left mb-4 md:mb-0">
          <p className="text-sm text-foreground/60">
            &copy; {currentYear} Russell Trzaska. All Rights Reserved.
          </p>
        </div>
        <div className="flex space-x-4">
          ...
          {/* Add other social links (YouTube, Facebook) as needed */}
        </div>
      </div>
    </footer>
  );
